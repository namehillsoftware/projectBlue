package com.lasthopesoftware.bluewater.client.connection.builder.live.GivenANetworkExists.AndAServerIsFoundViaLookup.AndTheUserNameIsAnEmptyString
...
class `When Getting The Live Connection` {
	private val urlProvider by lazy {
		...
		every { connectionSettingsLookup.lookupConnectionSettings(LibraryId(44)) } returns ConnectionSettings(
			accessCode = "gooPc",
			userName = "",
			password = ""
		).toPromise()
