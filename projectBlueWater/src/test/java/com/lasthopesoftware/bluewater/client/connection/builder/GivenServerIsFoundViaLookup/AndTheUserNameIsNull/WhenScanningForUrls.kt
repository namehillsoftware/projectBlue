...
class WhenScanningForUrls {
	...
	private val urlProvider by lazy {
		...
		every { connectionSettingsLookup.lookupConnectionSettings(LibraryId(62)) } returns ConnectionSettings(
			accessCode = "gooPc",
			userName = null,
			password = null
		).toPromise()
...
""".toByteArray().inputStream()
		...
		urlScanner.promiseBuiltUrlProvider(LibraryId(62)).toExpiringFuture().get()
	}
