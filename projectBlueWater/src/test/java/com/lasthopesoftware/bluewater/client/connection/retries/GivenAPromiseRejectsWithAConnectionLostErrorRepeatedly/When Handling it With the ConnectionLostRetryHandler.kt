package com.lasthopesoftware.bluewater.client.connection.retries.GivenAPromiseRejectsWithAConnectionLostErrorRepeatedly
...
class `When handling it with the ConnectionLostRetryHandler` {
	...
	private var exception: ConnectionUnavailableException? = null
	...
	fun act() {
		...
		try {
			...
			exception = ee.cause as? ConnectionUnavailableException
		} finally {
