  ...
  "subsonic-response": {
	...
	fun `then the items are correct`() {
		assertThat(items).containsExactly(
			Item(key = "playlist", value = "Recently Played", playlistId = PlaylistId("14f6b170-3eb1-4e17-995a-733cb23f5c9f")),
			Item(key = "playlist", value = "Test", playlistId = PlaylistId("37ff086d-a35b-4888-9cd5-73d6db7b5e7f")),
		)
	}
}
