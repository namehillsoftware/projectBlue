package com.lasthopesoftware.bluewater.client.browsing.files.uri.GivenAFileThatIsAvailableRemotely.AndAvailableOnDisk.AndExistingFileUsageIsNotAllowed
	...
	companion object {
		...
		private val returnedFileUri by lazy {
			...
			val bestMatchUriProvider = BestMatchUriProvider(
				mockk {
					every { promiseLibrary(LibraryId(libraryId)) } returns Library(id = libraryId).toPromise()
				},
