package com.lasthopesoftware.bluewater.client.connection.live.GivenANetworkExists.AndAServerIsFoundViaLookup.AndTheLocalIpsCanBeConnected
...
class `When Getting The Live Connection` {
	private val serverConnection by lazy {
		...
		every { connectionSettingsLookup.lookupConnectionSettings(LibraryId(17)) } returns MediaCenterConnectionSettings(accessCode = "gooPc").toPromise()
		...
		urlScanner.promiseLiveServerConnection(LibraryId(17)).toExpiringFuture().get()
	}
