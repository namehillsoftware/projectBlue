package com.lasthopesoftware.bluewater.client.connection.lookup.mediacenter.GivenServerInfoErrorXml
...
<msg>Keyid gooPc not found.</msg></Response>""",
	...
	fun `then a server discovery exception is thrown with the correct message`() {
		assertThat(exception?.message).contains("Unable to find server for library 14.")
	}
}
