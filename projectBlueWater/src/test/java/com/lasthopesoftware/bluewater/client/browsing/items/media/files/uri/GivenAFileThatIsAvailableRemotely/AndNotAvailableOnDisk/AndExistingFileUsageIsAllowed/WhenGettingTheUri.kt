package com.lasthopesoftware.bluewater.client.browsing.items.media.files.uri.GivenAFileThatIsAvailableRemotely.AndNotAvailableOnDisk.AndExistingFileUsageIsAllowed
...
class WhenGettingTheUri {
	...
	companion object {
		private val returnedFileUri by lazy {
			...
			bestMatchUriProvider.promiseFileUri(ServiceFile(3)).toExpiringFuture().get()
		}
	}
