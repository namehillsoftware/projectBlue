package com.lasthopesoftware.bluewater.client.stored.library.items.files.destination.GivenAStoredFile.AndAContentUri.AndTheFileExists.AndTheDownloadIsNotComplete
		...
		private val mut by lazy {
            StoredFileUriDestinationBuilder(
                ...
                mockk {
                    ...
                    every { openFileDescriptor(expectedContentUri, "r") } returns mockk(relaxUnitFun = true)
                    every {
                        openOutputStream(
                            expectedContentUri,
                            "wt"
