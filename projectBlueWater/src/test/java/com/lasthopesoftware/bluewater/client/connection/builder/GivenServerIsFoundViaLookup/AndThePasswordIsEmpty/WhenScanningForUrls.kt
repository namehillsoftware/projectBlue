package com.lasthopesoftware.bluewater.client.connection.builder.GivenServerIsFoundViaLookup.AndThePasswordIsEmpty
...
class WhenScanningForUrls {
	...
	companion object {
		...
		fun before() {
			...
			every { connectionTester.promiseIsConnectionPossible(match { a -> "http://1.2.3.4:143/MCWS/v1/" == a.urlProvider.baseUrl.toString() }) } returns true.toPromise()
			...
			urlProvider = urlScanner.promiseBuiltUrlProvider(LibraryId(56)).toExpiringFuture().get()
		}
	}
