package com.lasthopesoftware.bluewater.client.browsing.items.list.GivenALibrary.AndItHasAnEmptyName
...
class WhenLoadingTheItems {
	...
	fun `then the item value is correct`() {
		assertThat(viewModel.itemValue.value).isEqualTo("5HCMsD")
	}
