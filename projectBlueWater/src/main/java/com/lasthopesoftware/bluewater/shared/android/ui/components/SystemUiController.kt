...
// Original source: https://github.com/google/accompanist/blob/main/systemuicontroller/src/main/java/com/google/accompanist/systemuicontroller/SystemUiController.kt
// Forked to continue using, as the edge-to-edge API is tricky to use in Compose views.
