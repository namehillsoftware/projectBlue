...
class PromiseDelay<Response> private constructor(private val delay: Duration) : Promise<Response>(), Runnable {
	...
	private inner class FutureCancellation(private val future: ScheduledFuture<*>) : Runnable {
		override fun run() {
			future.cancel(false)
