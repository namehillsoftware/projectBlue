...
public class SearchFilesActivity extends AppCompatActivity implements IItemListViewContainer {
	...
	private void handleIntent(Intent intent) {
        ...
        final ITwoParameterRunnable<IFluentTask<Void, Void, List<IFile>>, List<IFile>> onSearchFilesComplete = new ITwoParameterRunnable<IFluentTask<Void,Void,List<IFile>>, List<IFile>>() {
