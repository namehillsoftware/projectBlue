...
import com.lasthopesoftware.bluewater.client.stored.sync.NotifyingSyncWorker
...
open class MainApplication : MultiDexApplication() {
	...
	override fun onCreate() {
		...
		NotifyingSyncWorker.promiseIsScheduled(this)
			.then { isScheduled -> if (!isScheduled) NotifyingSyncWorker.scheduleSync(this) }
	}
