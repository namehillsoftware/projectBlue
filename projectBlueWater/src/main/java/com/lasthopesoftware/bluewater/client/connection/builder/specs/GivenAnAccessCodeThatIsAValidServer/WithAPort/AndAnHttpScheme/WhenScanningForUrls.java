package com.lasthopesoftware.bluewater.client.connection.builder.specs.GivenAnAccessCodeThatIsAValidServer.WithAPort.AndAnHttpScheme;
...
public class WhenScanningForUrls {
	...
	public static void before() throws InterruptedException, ExecutionException {
		...
		final UrlScanner urlScanner = new UrlScanner(connectionTester, mock(LookupServers.class), mock(ProvideOkHttpClients.class));

		urlProvider = new FuturePromise<>(
			urlScanner.promiseBuiltUrlProvider(new Library()
				.setAccessCode("http://gooPc:3504"))).get();
	}
