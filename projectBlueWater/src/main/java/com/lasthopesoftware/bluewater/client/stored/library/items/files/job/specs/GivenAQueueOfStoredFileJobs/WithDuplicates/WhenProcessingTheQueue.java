package com.lasthopesoftware.bluewater.client.stored.library.items.files.job.specs.GivenAQueueOfStoredFileJobs.WithDuplicates;
...
public class WhenProcessingTheQueue {
	...
	private static final Iterable<StoredFileJob> storedFileJobs = Arrays.asList(
