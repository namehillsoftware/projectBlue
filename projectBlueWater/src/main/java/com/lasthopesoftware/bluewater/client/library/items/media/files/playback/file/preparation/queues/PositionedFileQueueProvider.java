...
public class PositionedFileQueueProvider implements IPositionedFileQueueProvider {
	...
	@Override
	public IPositionedFileQueue getCompletableQueue(List<ServiceFile> playlist, int startingAt) {
	...
	private static List<PositionedFile> getTruncatedList(List<ServiceFile> playlist, int startingAt) {
