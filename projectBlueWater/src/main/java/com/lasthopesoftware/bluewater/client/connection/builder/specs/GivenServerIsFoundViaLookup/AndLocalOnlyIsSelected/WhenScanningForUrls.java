...
public class WhenScanningForUrls {
	...
	public static void before() throws InterruptedException, ExecutionException {
		...
		when(connectionTester.promiseIsConnectionPossible(argThat(a -> Arrays.asList("http://192.168.1.56:143/MCWS/v1/", "http://1.2.3.4:143/MCWS/v1/").contains(a.urlProvider.getBaseUrl()))))
