package com.lasthopesoftware.bluewater.client.connection.builder.specs.GivenServerIsFoundViaLookup.AndTheUserNameIsAnEmptyString;
...
public class WhenScanningForUrls {
	...
	public static void before() throws InterruptedException, ExecutionException {
		...
		when(serverLookup.promiseServerInformation(new LibraryId(44)))
