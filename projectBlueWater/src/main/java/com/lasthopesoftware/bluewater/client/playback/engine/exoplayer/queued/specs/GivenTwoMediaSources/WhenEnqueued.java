...
public class WhenEnqueued extends AndroidContext {
	...
	private static final MediaSource mockMediaSourceOne = mock(MediaSource.class);
	...
	public void before() throws Exception {
		...
		new FuturePromise<>(mediaSourceQueue.enqueueMediaSource(mockMediaSourceOne)).get();
	...
	public void thenTheFirstMediaSourceIsPreparedCorrectly() {
		verify(mockMediaSourceOne).prepareSource(argThat(a -> a == exoPlayer), booleanThat(a -> !a), any());
	}
