...
public class ClickItemListener implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        ItemProvider.provide(SessionConnection.getSessionConnectionProvider(), item.getKey())
            .onComplete(new TwoParameterRunnable<FluentSpecifiedTask<String,Void,List<Item>>, List<Item>>() {
                @Override
                public void run(FluentSpecifiedTask<String, Void, List<Item>> owner, List<Item> items) {
