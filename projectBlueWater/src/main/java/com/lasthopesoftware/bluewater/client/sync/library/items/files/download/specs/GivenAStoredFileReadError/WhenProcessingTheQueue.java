package com.lasthopesoftware.bluewater.client.sync.library.items.files.download.specs.GivenAStoredFileReadError;

import android.os.Build;
import android.support.annotation.RequiresApi;
import com.annimon.stream.Stream;
import com.lasthopesoftware.bluewater.client.library.items.media.files.ServiceFile;
import com.lasthopesoftware.bluewater.client.sync.library.items.files.download.StoredFileDownloader;
import com.lasthopesoftware.bluewater.client.sync.library.items.files.job.ProcessStoredFileJobs;
...
import com.lasthopesoftware.bluewater.client.sync.library.items.files.job.exceptions.StoredFileReadException;
...
public class WhenProcessingTheQueue {
	...
	public static void before() {
		...
		storedFileDownloader.setOnFileReadError(j -> badStoredFile = j);
