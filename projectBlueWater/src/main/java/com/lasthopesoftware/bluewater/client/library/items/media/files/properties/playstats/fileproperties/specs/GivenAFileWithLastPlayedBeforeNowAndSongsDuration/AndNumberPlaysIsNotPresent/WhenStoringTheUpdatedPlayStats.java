...
public class WhenStoringTheUpdatedPlayStats {
	...
	public void thenTheLastPlayedIsRecent() {
		assertThat(Long.parseLong(fileProperties.get(SessionFilePropertiesProvider.LAST_PLAYED))).isCloseTo(Duration.millis(System.currentTimeMillis()).getStandardSeconds(), offset(10L));
	}

	@Test
	public void thenTheNumberPlaysIsIncremented() {
		assertThat(fileProperties.get(SessionFilePropertiesProvider.NUMBER_PLAYS)).isEqualTo("1");
	}
}
