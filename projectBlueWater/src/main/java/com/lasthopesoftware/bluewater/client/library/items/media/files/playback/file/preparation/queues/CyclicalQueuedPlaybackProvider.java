	...
	OneParameterAction<IBufferingPlaybackHandler>
{
	...
	public CyclicalQueuedPlaybackProvider(List<IFile> playlist, IPlaybackPreparerTaskFactory playbackPreparerTaskFactory) {
	...
	private IPromise<IBufferingPlaybackHandler> getNextPreparingMediaPlayerPromise(int preparedAt) {
		...
		return new Promise<>(playbackPreparerTaskFactory.getPlaybackPreparerTask(file, preparedAt));
	}
