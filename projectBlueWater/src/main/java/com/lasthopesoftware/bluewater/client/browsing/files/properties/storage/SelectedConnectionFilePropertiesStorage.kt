...
class SelectedConnectionFilePropertiesStorage(private val selectedConnectionProvider: ProvideSelectedConnection, private val innerConstructor: (IConnectionProvider) -> ScopedFilePropertiesStorage) : UpdateScopedFileProperties {
