		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			tv.setOnClickListener(new ListView.OnClickListener() {
				...
				public void onClick(View v) {
					...
					String fileUrl = JrSession.accessDao.getJrUrl("File/GetFile", "File=" + Integer.toString(file.mKey));
					Intent svcIntent = new Intent(mContext, StreamingMusicService.class);
					svcIntent.setAction(StreamingMusicService.ACTION_PLAY);
					svcIntent.setData(Uri.parse(fileUrl));
