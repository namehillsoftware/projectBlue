...
public class JrSession {
	...
	public static synchronized void SaveSession(SharedPreferences.Editor prefsEditor) {
	...
	public static synchronized boolean CreateSession(SharedPreferences prefs) {
