	...
	override fun before() {
        ...
        PlaybackNotificationBroadcaster(
            com.lasthopesoftware.bluewater.client.playback.nowplaying.FakeNowPlayingRepository(
                com.lasthopesoftware.bluewater.client.playback.nowplaying.singleNowPlaying(
                    LibraryId(libraryId),
            ...
            mockk {
                ...
                } returns newFakeBuilder(context, loadingNotification).toPromise()
                every {
                ...
                } returns newFakeBuilder(context, startedNotification).toPromise()
            },
            mockk {
